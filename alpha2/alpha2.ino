...
//--------------------------------------------------------------------
  ...
  ind_speed = (((float)motorSpeed/4076) * speedToMM) ; // speed in mm/s for drive wheel 
  ind_pos   = (((float)stepper1.currentPosition()/4076) * speedToMM); // step position in mm for drive wheel
